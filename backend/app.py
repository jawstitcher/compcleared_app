...
def generate_pdf_report():
    ...
    story.append(Paragraph(
        "This report summarizes the incident records entered in CompCleared, including available dates, times, "
        "locations, incident types, and descriptions. It is provided for record organization and is not legal advice.",
        body_style
    ))
    story.append(Spacer(1, 20))
...
def generate_written_plan():
    ...
    story.append(Paragraph("Plan template generated by CompCleared. Review and adapt it for your business; it is not legal advice.", body_style))
